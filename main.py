...
class ANN:
    ...
    def fit(self, X, Y, learning_rate=0.01, n_iterations=200):
        np.random.seed(1)
...
if __name__ == '__main__':
    ...
    ann.fit(train_x.reshape(11272, 784), train_y, learning_rate=0.1, n_iterations=1000)
    ann.predict(train_x.reshape(11272, 784), train_y)
    ann.predict(test_x.reshape(1866, 784), test_y)
    ann.plot_cost()
